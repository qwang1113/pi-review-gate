 ...
 * label is flagged when it contains a NON-LATIN letter (CJK/Kana/Hangul/
 * Cyrillic/…) or CJK punctuation. Latin-with-diacritics (café), digits,
 * punctuation, URLs and emoji all pass.
 *
