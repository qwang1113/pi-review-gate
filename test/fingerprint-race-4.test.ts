...
// Racily-clean regression — GROUP 4 OF 4 (75 rounds in its own repo). The
...
test("a same-size edit in the racy window is never invisible to the fingerprint (racily-clean, group 4/4)", () => {
  assertRacyCleanWindow(computeFingerprint, 75, "group 4/4");
});
